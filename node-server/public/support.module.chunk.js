    ...
    SearchPipe.prototype.transform = function (values, query) {
        ...
        if (query != '') {
            ...
            for (var i = 0, len = values.length; i < len; i++)
                if (values[i].productName.toUpperCase().indexOf(query) != -1)
...
var AudienceComponent = /** @class */ (function () {
    ...
    AudienceComponent.prototype.ngOnInit = function () {
        ...
        this.audienceForm = this.formBuilder.group({
            ...
            transactionCurrency: ['INR', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* Validators */].required],
            userRole: ["AGGREGATOR"],
            userId: []
        });
...
var BillingComponent = /** @class */ (function () {
    ...
    BillingComponent.prototype.initRulesArray = function () {
        return this.formBuilder.group({
            ...
            paymentCycle: [, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* Validators */].required] //paymentCycle - num 1,3,6,12
        });
    };
...
var FormService = /** @class */ (function () {
    ...
    FormService.prototype.toggleFromTabs = function (from, to) {
